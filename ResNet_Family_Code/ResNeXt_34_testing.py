...
"-------------------------------------------------------------------------------------------------"
"""
This is a demo code of ResNeXt.
    1) ResNeXt[1] in theory, works better than ResNet[8](which works as almost convex problem[2]), almost equals to performance of DenseNet[10] as comparaion of 6.figure of[9] especially on the following items:
        a) 
        b) 
...
class Normal_Residual_Block(nn.Module): #----- In this version, the "cardinality" is implemented by using property "group" in PyTorch for each conv layer
    def __init__(self, number_in_channel, number_out_channel, stride = 1, linear_projection = None, num_of_group = 32): #----- num_of_group is "cardinality"
...
print('this is our ResNet: ', our_resnext)
